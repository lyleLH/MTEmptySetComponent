...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MTEmptySetComponent.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/v2top1@163.com/MTEmptySetComponent'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'v2top1@163.com' => 'tomliu@yeahka.com' }
  s.source           = { :git => 'https://github.com/v2top1@163.com/MTEmptySetComponent.git', :tag => s.version.to_s }
